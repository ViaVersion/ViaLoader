...
```groovy
implementation "com.viaversion:viaversion-common:5.3.0"
implementation "com.viaversion:viabackwards-common:5.3.0"
implementation "com.viaversion:viarewind-common:4.0.6"
implementation "net.raphimc:ViaLegacy:3.0.8"
